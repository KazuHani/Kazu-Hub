...
eq('summer 1pm: sun near the profile-height crest', L.skyBodyState(780, 172), { body: 'sun', x: 48.67, y: 19.04, alt: 0.999, low: false });
eq('summer midnight: moon a third along the arc', L.skyBodyState(0, 172), { body: 'moon', x: 35.33, y: 23.42, alt: 0.866, low: false });
eq('sunrise: left horizon, golden', L.skyBodyState(300, 172), { body: 'sun', x: 6, y: 52, alt: 0, low: true });
eq('just before sunset: right horizon, golden', L.skyBodyState(1289, 172), { body: 'sun', x: 93.91, y: 51.9, alt: 0.003, low: true });
eq('winter midday is still the sun', L.skyBodyState(727, 355), { body: 'sun', x: 49.91, y: 19, alt: 1, low: false });
eq('winter 1am: moon past the top', L.skyBodyState(60, 355), { body: 'moon', x: 54.74, y: 19.47, alt: 0.986, low: false });
eq('summer solar noon follows a supplied profile height', L.skyBodyState(795, 172, 23.5), { body: 'sun', x: 50, y: 23.5, alt: 1, low: false });
